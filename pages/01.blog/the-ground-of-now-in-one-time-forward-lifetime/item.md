---
title: 'The Ground Of Now In One Time Forward Lifetime'
hero_classes: 'text-dark title-h1h2 overlay-dark hero-small parallax'
hero_image: Untied-1tled-1.png
taxonomy:
    category:
        - blog
    tag:
...
feed:
    limit: 10
media_order: 'ounilogo.png,unsplash-london-night.jpg,unsplash-xbrunel-johnson.jpg,Untied-1tled-1.png'
published: true
---

The ground of now in one time forward lifetime is the ground of present wisdom, where what was not obvious in the past becomes obvious now. Some knowledge emerges into our understanding due to changes in conceptions such as the conception of formal logic and the new vistas that Bolean logic opened less obvious than the development of three dimensional art it is the predicate of our most delusional modern conception of our own individuality as we apply its findings subjectively as an hidden tool in our confirmation bias. The limited use of Bolean logic in modern novels and self stories involving connections and separations from soul and oneself makes the creation of meaning effortlessly compliant with the least informed of all our awareness as is made obvious by the use of yuck in a decision tree.

that is maintained by our incomp
