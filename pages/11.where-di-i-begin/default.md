---
title: 'What''s Next Now, Where Di I Begin'
hide_git_sync_repo_link: false
---

Do not ask who made the arrow that pierced the hope vessel in your heart, where the sadness that made your knees weak and your eyes weep simply ask only what is your deepest desire unbounded by polluted conceptions of what is here now.
Hope that springs from misconception misses actual potential in the present it cannot imagine. Just to start us off together in a similar now not for the future just for now let us imagine the iGame
The iGame in a private Me-mind game that uses iStates including iStates that are bound by natural language 'I Am' states are challenged to follow the knowledge in local emergent knowledge flows.as a process game where first iState to the knowledge wins in pursuit of Positive Present Participation in my human Me-Mind.
where and how do I make it better from the inside out.
