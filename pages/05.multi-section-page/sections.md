...
---
These are interdisciplinary solutions which depend upon synthetic integration of the EmptiSelf conception which is what makes the Clear Core Evanescent iStates that are required for the ground up communication using flattened hierarchies that can include weak will signal awareness, which is used in the .  
